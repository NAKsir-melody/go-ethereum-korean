...
// RequestProofs함수는 원격노드로부터 배치개의 머클증명을 받는다
...
// RequestHelperTrieProofs함수는 원격노드로부터 여러개의 헬퍼트라이 머클증명을 요청한다
...
// SendTxStatus는 원격 트렌젝션풀에 추가되어야 할 트렌젝션들을 전달한다
...
// notify함수는 피어의 추가와 제거에 대해 알람을 받을 서비스를 추가한다
