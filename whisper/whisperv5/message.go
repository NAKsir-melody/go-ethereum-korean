...
// appendPadding은 수도랜덤 패딩 바이트와 패딩플래그를 추가한다
// 마지막 바이트는 패딩의 크기를 포함한다
...
// sign은 메시지에 대한 암호학적서명을 계산하고, 설정한다
...
// Validate는 유효성을 체크하고 성공할 경우 필드들을 푼다
